...
<div class="bg-gray-200 h-screen grid grid-cols-12">
    ...
    <div class="col-span-8 flex flex-col items-center justify-center">
		<form on:submit|preventDefault={updateDoctorProfile}>
                ...
                <div class="flex flex-col justify-center pb-5 px-10 gap-y-5 min-w-[30%] rounded-lg">                         
					...
					<div class="flex space-x-4">
						<div class="flex space-x-3 items-center">
							...
							<input type="department" name="department" id="department" required  bind:value={profile["department"]} placeholder="" class="p-2 mb-2 border-b border-gray-600 outline-none focus:border-teal-600"  />                        
						</div>
						<div class="flex space-x-3 items-center">
							<label for="specialty">Specialty:</label>
							<input type="specialty" name="specialty" id="specialty" required  bind:value={profile["specialty"]} placeholder="Specialty" class="p-2 mb-2 border-b border-gray-600 outline-none focus:border-teal-600"  />                        
						</div>
					</div>
                    <div class="flex space-x-4">
						<div class="flex space-x-3 items-center">
							<label for="medicalLicenceNumber">Medical Licence Number:</label>
							<input type="medicalLicenceNumber" name="medicalLicenceNumber" id="medicalLicenceNumber" required  bind:value={profile["medicalLicenceNumber"]} placeholder="" class="p-2 mb-2 border-b border-gray-600 outline-none focus:border-teal-600"  />                        
						</div>    
					...
					<button type="submit" class="bg-teal-700 hover:bg-teal-600 p-3 rounded-md text-gray-200">Update Doctor Profile</button>
				</div>
			</div>
		</form>		
	</div>
